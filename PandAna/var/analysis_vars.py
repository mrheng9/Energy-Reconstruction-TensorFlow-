...
# NOTE (from mbaird):   Would really like  to rename these 'kCVNe17'...
...
def kLongestProng(tables):
    df = tables['rec.vtx.mlvertex.fuzzyk.png']['len']
...
def kEMEnergy(tables):
    ...
    shwlid_df = tables['rec.vtx.mlvertex.fuzzyk.png.shwlid']
    prim_png = shwlid_df['calE'][(shwlid_df['rec.vtx.mlvertex.fuzzyk.png_idx']==0)]

  
    png_df = tables['rec.vtx.mlvertex.fuzzyk.png']
