...
def GetPeriod(run, det):
  if (det == detector.kFD):
    ...
    if (run <= 31167): return 7
    if (run <= 32397): return 8
    if (run <= 34573): return 9
    if (run <= 38300): return 10
    else: return 11
  if (det == detector.kND):
    ...
    if (run <= 12955): return 7
    if (run <= 13131): return 8
    if (run <= 13427): return 9
    if (run <= 13886): return 10
    else: return 11
#
